...
if __name__ == "__main__":    
    ...
    # plot_result_4in1
    plt.figure(figsize = (7.2 * 2, 4.4 * 2))
    plt.subplot(221)
    ...
    plt.yscale('linear')
    plt.xscale('linear')
    plt.xlabel('Iterations , M = 32', {'size': 18})
    ...
    plt.yscale('linear')
    plt.xscale('linear')
    plt.xlabel('Time (s) , M = 32', {'size': 18})
    plt.ylabel('2-Wasserstein Distance', {'size': 18})
    plt.tick_params(labelsize = 18)
    plt.subplot(223)
    for method_name in order:
    ...
    plt.yscale('linear')
    plt.xscale('linear')
    plt.xlabel('Iterations , M = 512', {'size': 18})
    plt.ylabel('2-Wasserstein Distance', {'size': 18})
    plt.tick_params(labelsize = 18)
    plt.subplot(224)
    for method_name in order:
    ...
    plt.yscale('linear')
    plt.xscale('linear')
    plt.xlabel('Time (s) , M = 512', {'size': 18})
    plt.ylabel('2-Wasserstein Distance', {'size': 18})
    plt.tick_params(labelsize = 18)
    plt.legend(fontsize = 18, ncol = 5, bbox_to_anchor=(-0.15, 2.6), loc=9, borderaxespad = 0)
